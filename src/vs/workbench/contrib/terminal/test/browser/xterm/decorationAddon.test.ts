...
suite('DecorationAddon', () => {
	...
	setup(async () => {
		...
		const logService = instantiationService.stub(ILogService, NullLogService);
		const capabilities = new TerminalCapabilityStore();
		capabilities.add(TerminalCapability.CommandDetection, instantiationService.createInstance(CommandDetectionCapability, xterm, logService));
